...
(yes || true) | /opt/android-sdk/cmdline-tools/latest/bin/sdkmanager --licenses > /dev/null 2>&1 || true

echo "Installing Android SDK packages..."
/opt/android-sdk/cmdline-tools/latest/bin/sdkmanager "platforms;android-34" "platforms;android-35" "platforms;android-36" "build-tools;34.0.0" "platform-tools"
...
if [ -n "$FOUND_APK" ]; then
    cp "$FOUND_APK" ../app-release.apk
    cp "$FOUND_APK" app-release.apk
    echo "APK_COPY_SUCCESS: $FOUND_APK"
else
